  ...
  return (
    <section className="bg-white py-20 border-t border-neutral-200 relative">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="swiper-button-prev absolute left-4 top-1/2 -translate-y-1/2 bg-white border border-neutral-200 p-3 rounded-full shadow-sm text-neutral-700 hover:text-blue-600 hover:shadow-md transition z-10">
          <FaChevronLeft size={18} />
        </div>

        <div className="swiper-button-next absolute right-4 top-1/2 -translate-y-1/2 bg-white border border-neutral-200 p-3 rounded-full shadow-sm text-neutral-700 hover:text-blue-600 hover:shadow-md transition z-10">
